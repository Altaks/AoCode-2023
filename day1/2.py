...
for line in value:
    ...
    while(len(line) > 0):
        for correspondance in mapping.keys():
            if line.startswith(correspondance):
                if first_digit is None:
                    first_digit = mapping[correspondance]
                    last_digit = mapping[correspondance]
                else:
                    last_digit = mapping[correspondance]
        line = line[len(correspondance):]
